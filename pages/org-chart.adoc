...
One of your most powerful tools in ChartHop is the **Org Chart**. After you upload your employee roster and historical data into the system, the Org Chart page allows you to easily navigate aspects of your organization, such as departments and teams, and view particular employee profiles.
...
3.  Select **Export**.
4. and then the grand finale!
** mini-one
** mini-two

5. Nono, this is the last!
